...
root.geomentry("1250x700+210+100")
...
#Registration No.
def registration_no():
    file=openpyxl.load_Workbook('Sudent_data.xlsx')
    sheet=file.active
    row=sheet.max_row
...
def Save():
    ...
    if N1=="" or C1=="Select Class" or D2=="" or Rel="" or S1=="" or fathername=="" or mothername=="" or F1=="" or M1=="":messagebox.showerror("error","Few Data is missing")
    else:
...
Label(obj,text="Date od Birth:",font="arial 13",bg=framebg,fg=framefg).place(x=30,y=100)
...
FO_entry = Entry(obj,textvariable=Father_Occpation,width=20,font="arial 10")
...
MO_entry = Entry(obj,textvariable=Mother_Occpation,width=20,font="arial 10")
...
label=Label(f,bg="black",image=img)
label.place(x=0,y=0)

#button

Button(root,text="Upload",width=19,height=2,font="arial 12 bold",bg="lightblue",command=showimage).place(x=1000,y=370)
saveButton(root,text="Save",width=19,height=2,font="arial 12 bold",bg="lightgreen",command=Save)
